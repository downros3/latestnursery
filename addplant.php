			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					...
					<tbody>
						...
						<form form name="addplant" method="post" action="add0.php" enctype='multipart/form-data'>
							...
							<hr>
							<center>
								<button Onclick="return ConfirmDelete();" type="Submit" name="Submit" class="btn btn-default">Add</button>
