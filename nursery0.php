		...
		<div class="container">
			<div class="row">
				...
				<?php
       					...
       					if(isset($_POST['Submit']))
							{
     							...
     							$low_p_name=$_POST['p_name'];
     							$p_name = strtolower($low_p_name);
       
       							$search= "SELECT * FROM plant WHERE p_name1 = '$p_name' || p_name2 = '$p_name' ||  p_name3 = '$p_name' || p_name4 = '$p_name'";

       							$result = mysqli_query($conn, $search) or die(mysqli_error());
       							
       							if($result->num_rows == 0)
       							{
       								echo "There are no nursery have that flower.";
       							}
                        				...
                        				while($row = mysqli_fetch_array($result))
                        					{
                        					 ...
                        					 $cu = "SELECT * from nursery WHERE nur_id = '$nur_id'";
       											$result2 = mysqli_query($conn, $cu) or die(mysqli_error());
						...
						echo "<br>"; echo "Operation Hours:"; echo $nur_open; echo $timex; echo $nur_close; echo $timex1; echo "</b>"; echo "<br><br>";
