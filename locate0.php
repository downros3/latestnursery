...
<?php
                    ...
                    $sql = "SELECT * from nursery WHERE nur_id = '$id'";
...
<head>
    ...
    <script src="http://maps.google.com/maps/api/js?key=AIzaSyBw6r6EFekz3p32EHqi7n4o07F5Z2CTnf8&sensor=true&libraries=places"></script>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        ...
                                        Search the plant:<br><br>
                                            ...
                                            <br><br>
                                            Nursery Details: <br><br>
                                            <table border ="1" width="100%">
                                                <td>Name:<?php echo $nur_name; ?> <br><br> Address:<?php echo $nur_address; echo $nur_post; echo $nur_city; echo $nur_state; ?> <br><br> Operation Hour:<?php echo $nur_open; echo $timex; echo "-"; echo $nur_close; echo $timex1; ?> <br><br> Phone Number:<?php echo $nur_phone; ?> <br><br> Website: <a href="<?php echo $nur_web; ?>">Click Here</a> </td><br>
                                            </table>
                                        </form>
                                    </font> 
...
<div id="mapCanvas">&#160;</div>
    <div id="directionsPanel">
        <br><a href="#geoLocation" id="useGPS" >Use My Location</a>
        <p><h3>[OR]</h3></p><br>
        <div class="directionInputs">
            <form>
                ...
                <p>
                    <label>B</label>
                    <?php echo    "<input type=text value='".$nur_address.",".$nur_post." ".$nur_city.",".$nur_state."' id='dirDestination' readonly>";
                ?>

                </p>
                <a href="#getDirections" id="getDirections">Get Directions</a>&nbsp|
